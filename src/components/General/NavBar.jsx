            ...
            <div className="flex pr-50 items-center">
                <Link to="/home">
                    <div className="flex flex-col items-center">
                        <img className="w-[25px] pt-[4px]" src='../assets/images/house-icon.png' />
                        <p className="text-[15px]">Início</p>
                    </div>
                </Link>
                <Link to="/notifications">
                    <div className="flex flex-col items-center pl-[30px]">
                        <img className="w-[25px]" src='../assets/images/notifications-icon.png' />
                ...
                <div className="flex items-center pl-[20px]">
                    <Link to="/profile">
                        <div className="rounded-[50%] p-[0px] items-center">
                            <img className="w-[45px] min-w-[45px]" src='../assets/images/profile-picture.svg' />
                        </div>
                    </Link>
                    <div>
                        <img className="pl-[10px] min-w-7 cursor-pointer" onClick={changeModal} src='../assets/images/down-arrow-icon.png'/>
